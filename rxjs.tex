...
\begin{figure}[H]
\centering
\includegraphics{subjects-intro-output}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics{behaviour-subject-output}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics{scheduler-output}
\end{figure}
...
\subsection{Fazit}
RxJS ist eine Sammlung von Libraries die asynchronen oder ereignisgesteuerte Programme mit Hilfe von Observable-Sequenzen aufgebaut sind.
