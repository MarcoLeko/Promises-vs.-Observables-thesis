...
Es gibt Operatoren für verschiedene Anwendungsfälle und können kategorisiert werden in: Kreation, Transformierung, Kombination, Multicasting und Fehlerbehandlung. Wie ursprünglich bereits erwähnt werden Operatoren mit der pipe() Methode an einem Observable angeschlossen. Da ein Teil der Kreationsoperatoren bereits abgehandelt wurden, wird mit den Transformationsoperatoren fortgefahren.


\subsection{Subjects}

Ein RxJS Subject ist eine spezialisierte Form von Observables. Hierbei sind die Datenströme von vornherein multicastingfähig. Dabei kennzeichnet ein Subject 2 Merkmale:
