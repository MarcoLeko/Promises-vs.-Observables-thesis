...
Diese Bachelorarbeit präsentiert Code aus einem Beispiel-Projekt. Dieser wird neben simulierten Anwendungsbeispielen, auch praxisnahe Beispiele wie z.B. einen Endpunkt-Aufruf an einer API enthalten. Das Repository ist zu finden unter: 
