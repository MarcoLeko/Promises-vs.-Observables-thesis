...
\noindent
Nun kann man mit dem Befehl \textbf{npm run start} die Typescript-Datei kompilieren. Daraufhin muss nur jeweilige Html-Seite geöffnet werden. Zusammenfassend kann man sagen, dass in dem synchronen Modell implizit auf die Aktionen gewartet wird, und in dem asynchronen Modell explizit. Als Diagramm abgebildet führt der Browser die Methoden wie folgt aus:
